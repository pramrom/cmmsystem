...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
        <div class="outer">
    <div>
        <h4 style="font:bold">Seleccione una Catagoria :</h4>
        <br />
           ...
           <asp:RadioButton name="Gender" OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="Patient" GroupName="Catagory" runat="server" Text="Paciente" value ="P" />
           <asp:RadioButton name="Gender"  OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="OtherStaff" GroupName="Catagory" runat="server" Text="Otros" value ="O" />
    </div>
        <div>
        </div>
        <div>
        ...
        <asp:button Text ="Buscar"  runat="server" type="submit" class="btn btn-primary"  OnClick="Search_btn" ></asp:button>
        <br />
