...
<body>
    <form id="form1" runat="server">
        <div id ="myclass">    
        <link rel="stylesheet" href="/assets/css/Roboto:400,100,300,500"/>
                        ...
                        <div class="col-sm-2"></div>
                            <div class="col-sm-8">
                             ...
                             <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Experience Range should be (0-5)" MinimumValue="0" MaximumValue="5" Type="Integer" ControlToValidate="Exp" Display="Dynamic" ForeColor="Red"></asp:RangeValidator>   
                                         <div class="form-group">
                                             <asp:TextBox ID="Salary" runat="server" type="text"  placeholder="Salary in Rupees" Width="221px" >0</asp:TextBox>
                                                <asp:TextBox ID="Charges_per_visit" runat="server" type="text"  placeholder="Charges_per_visit in Rupees" Width="227px" >0</asp:TextBox>
                                             <asp:TextBox ID="Exp" runat="server" type="text"  placeholder="Experience (0-5)" Width="229px" >0</asp:TextBox>
                                        </div>
