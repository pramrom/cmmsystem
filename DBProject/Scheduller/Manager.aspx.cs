...
namespace DBProject.Scheduller
{
    public partial class Manager : System.Web.UI.Page
    {
        ...
        {
            DataTable doctors = myDAL.LoadDoctors();

            DayPilotScheduler1.Resources.Clear();
            foreach (DataRow row in doctors.Rows)
            {
                DayPilotScheduler1.Resources.Add((string)row["Name"], Convert.ToString(row["DoctorId"]));
            }
        }
        ...
        {
            DataTable table = myDAL.LoadAppointments(DayPilotScheduler1.VisibleStart, DayPilotScheduler1.VisibleEnd);
        ...
        private void CreateShift(DateTime start, DateTime end, int doctorId)
        {
            ...
            myDAL.CreateAppointment(doctorId, start, end);
        }
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            ...
            myDAL.DeleteAppointmentsFree(start, end);
