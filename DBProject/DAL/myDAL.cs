...
namespace DBProject.DAL
{
	...
	public class myDAL
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Doctor] ORDER BY [Name]", connString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE [AppointmentId] = @id", connString);
            da.SelectCommand.Parameters.AddWithValue("id", id);
            DataTable dt = new DataTable();
            da.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE [DoctorId] = @doctor AND NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", connString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", connString);
            da.SelectCommand.Parameters.AddWithValue("start", start);
            da.SelectCommand.Parameters.AddWithValue("end", end);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        {
            //SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM [Appointment] WHERE ([AppointmentStatus] = 'free' OR ([AppointmentStatus] <> 'free' AND [AppointmentPatientSession] = @session)) AND NOT (([AppointmentEnd] <= @start) OR ([AppointmentStart] >= @end))", connString);
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT top 1 * FROM [Doctor] ORDER BY [Name]", connString);
            DataTable dt = new DataTable();
            da.Fill(dt);
            if (dt.Rows.Count > 0)
            {
